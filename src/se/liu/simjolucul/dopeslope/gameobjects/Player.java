...
public class Player {
    ...
    public Point[] getSkiTipPositions() {
        ...
        return new Point[]{
                ...
                new Point((int) worldX[1] + RIGHT_SKI_TIP_X_OFFSET, (int) worldY[1])
        };
    }
    ...
    public void draw(Graphics2D g2d) {
        ...
        // Shake effect at high speed - combine into a Point
        ...
        if (currentSpeed > SHAKE_SPEED_THRESHOLD) {
            ...
            shake.x = Math.sin(shakeTime * SHAKE_X_FREQUENCY) * intensity;
            shake.y = Math.cos(shakeTime * SHAKE_Y_FREQUENCY) * intensity;
        }
    ...
    private void drawFallbackSkier(Graphics2D g2d) {
        ...
        int skiYPosition = (int) (-skiLength / SKI_TIP_Y_OFFSET_FACTOR);
